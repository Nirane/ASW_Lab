...
/usr/bin/tmux send-keys -t ${SESSION_NAME} "/root/ASW4_PK_DW/LAB/ASW_Lab/Lab1/zad1/button.py" C-m
/usr/bin/tmux split-window -t ${SESSION_NAME}
/usr/bin/tmux send-keys -t ${SESSION_NAME} "source /root/ASW4_PK_DW/LAB/ASW_Lab/virtenv/bin/activate" C-m
/usr/bin/tmux send-keys -t ${SESSION_NAME} "/root/ASW4_PK_DW/LAB/ASW_Lab/Lab1/zad1/led.py" C-m
/usr/bin/tmux split-window -t ${SESSION_NAME}
/usr/bin/tmux send-keys -t ${SESSION_NAME} "source /root/ASW4_PK_DW/LAB/ASW_Lab/virtenv/bin/activate" C-m
/usr/bin/tmux send-keys -t ${SESSION_NAME} "/root/ASW4_PK_DW/LAB/ASW_Lab/Lab1/zad1/switch_led_other.py" C-m
